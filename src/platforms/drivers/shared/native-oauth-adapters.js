...
const claudeSettingsManager = require('../claude/native-config-implementation');
...
function inspectClaudeState() {
  const { getProxyStatus } = require('../claude/proxy-implementation');
...
function inspectCodexState() {
  const { getCodexProxyStatus } = require('../codex/proxy-implementation');
...
function inspectGeminiState() {
  const { getGeminiProxyStatus } = require('../gemini/proxy-implementation');
...
function inspectOpenCodeState() {
  const { getOpenCodeProxyStatus } = require('../opencode/proxy-implementation');
...
function inspectOmpState() {
  const { getOmpProxyStatus } = require('../omp/proxy-implementation');
  const { isManagedOmpProvidersActive } = require('../omp/native-config-implementation');
