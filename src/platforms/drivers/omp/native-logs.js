...
function createDriver({ pathContext } = {}) {
  ...
  return {
    ...
    createNativeLogCursor({ skipInitialParse = false, onDiagnostic } = {}) {
      const native = createOmpUsageEventCursor(getOmpSessionPaths().sessions, { skipInitialParse, onDiagnostic });
      return {
