...
const { getOmpAuthProviderSnapshot } = require('./auth-providers');
...
function createDriver(context = {}) {
  return createApiOperationsDriver({
    ...
    operationHandlers: {
      ...
      getConfigAuthProviders: (requestContext) => ({
        success: true,
        ...getOmpAuthProviderSnapshot({
          forceRefresh: requestContext.query?.forceRefresh === 'true'
        })
      }),
      getConfigResources: () => readResources()
    }
  });
}
