        ...
        <div class="stats-bar">
          <span class="stats-text">
            ...
            <template v-if="serverCount > 0">
              · Claude: {{ stats.claude }} · Codex: {{ stats.codex }} · Gemini: {{ stats.gemini }} · OpenCode: {{ stats.opencode }} · OMP: {{ stats.pi }}
            </template>
          </span>
              ...
              >
                ...
                <div class="card-apps">
                  ...
                  <label class="app-toggle" @click.stop>
                    <n-switch
                      size="small"
                      :value="server.apps?.pi"
                      @update:value="(v) => toggleApp(server.id, 'pi', v)"
                    />
...
const stats = computed(() => {
  ...
  return {
    ...
    pi: list.filter(s => s.apps?.pi).length
  }
})
